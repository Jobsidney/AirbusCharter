...
We operate as an independent charter platform, focused exclusively on the ACJ family — from the ACJ TwoTwenty to the flagship ACJ350. Our role is not to promote aircraft manufacturers, nor to act as a generic charter marketplace, but to advise, structure, and execute complex private aviation missions using some of the world's most capable aircraft. </p>
          ...
          <div className="aboutUsFeatures">
            <div className="aboutUsFeatureItem">
              <div className="aboutUsFeatureIconCircle">
                <svg
                  className="aboutUsFeatureIconSvg"
                  fill="currentColor"
                  viewBox="0 0 512 512"
                >
              ...
              <h3 className="aboutUsH3">
                Elite Fleet
              </h3>
              <p className="aboutUsSubtitleSmall14">
        ...
        <div className="aboutUsImages">
          ...
          <div className="flexColGap4">
            ...
            <div className="aboutUsVipCounter">
              <div className="aboutUsVipNumber">
                390+
              </div>
              <div className="aboutUsVipLabel">
                VIP Members
              </div>
            </div>
          </div>
